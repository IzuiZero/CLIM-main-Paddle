...
from paddle.vision.transforms import Normalize, Compose, Resize, CenterCrop, RandomResizedCrop, InterpolationMode, ToTensor
...
def get_scale(img, new_image):
    ...
    if isinstance(new_image, paddle.Tensor):
